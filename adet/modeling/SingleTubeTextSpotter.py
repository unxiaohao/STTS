...
class SingleTubeTextSpotter(nn.Module):
    """
    ...
    def __init__(self, cfg):
        ...
        weight_dict = {
            ...
            "loss_ss_vector": loss_cfg.SPATIAL_SEMANTIC_WEIGHT,
        }
        ...
        if cfg.MODEL.TRANSFORMER.BOUNDARY_HEAD:
            dec_losses = ["labels", "texts", "ctrl_points", "bd_points", "ss_vector"]
        else:
            dec_losses = ["labels", "texts", "ctrl_points", "ss_vector"]
    ...
    def prepare_targets(self, targets):
        ...
        for targets_per_image in targets:
            ...
            gt_ss_vector_wh = targets_per_image.ss_vector
            gt_ss_vector = gt_ss_vector_wh.reshape(-1, 1, 2) / \
